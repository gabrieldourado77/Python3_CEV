...
print('='*60)
print('Você receberá:')
print(f'{cedula200} cédula(s) de 200')
print(f'{cedula100} cédula(s) de 100')
print(f'{cedula50} cédula(s) de 50')
print(f'{cedula20} cédula(s) de 20')
print(f'{cedula10} cédula(s) de 10')
print(f'{cedula05} cédula(s) de 5')
print(f'{cedula02} cédula(s) de 2')
print(f'{moeda01} moeda(s) de 1')
print('='*60)
